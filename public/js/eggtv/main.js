...
//                location.reload();
            ...
            success: function (data) {
                console.log('data.contents22222');
                console.log(data.contents);
...
//                location.reload();
    ...
    $(document).on('click','.new_open_btn', function (){
        NewChromeWindow.postMessage('https://www.englishegg.co.kr/customMem/eggtv/eggtvProductCheck.php');
    });
