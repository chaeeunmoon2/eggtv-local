...
$(function () {
    ...
    $('.btn-back').on('click', function () {
        window.flutter_inappwebview.callHandler('Navigation','close');
    ...
    $('.btn-eggtalk').on('click', function () {
        ...
        window.flutter_inappwebview.callHandler('Navigation','guide');
    ...
    $(document).on('click', '.btn-mypage', function() {
        window.flutter_inappwebview.callHandler('Navigation','user_page');
        // Navigation.postMessage('user_page');
        $('.normal_pop').css('display', 'none');
    });
    $('.btn-bluetooth').on('click', function () {
        window.flutter_inappwebview.callHandler('Navigation','bluetooth');
